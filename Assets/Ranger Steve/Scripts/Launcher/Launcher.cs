...
namespace Com.LavaEagle.RangerSteve
{
    public class Launcher : Photon.PunBehaviour
    {
        ...
        public override void OnDisconnectedFromPhoton()
        {
            ...
            // #Critical
            // Bring the user back to the main menu and eventually we can show an error message.
        ...
        public override void OnPhotonRandomJoinFailed(object[] codeAndMsg)
        {
            ...
            // #Critical
            // We failed to join a random room, maybe none exists or they are 
            // all full. No worries, we create a new room.
